  ...
  return (
    ...
    <Loader />
      <Canvas shadows camera={{ position: [0, 0, 20], fov:40 }}>
        ...
        <Model3 scale={2.5} position={[0, -1.1, 0]} />
        </Suspense>
        ...
        <Environment resolution={512}  >
          ...
          <Lightformer intensity={5} rotation-x={Math.PI / 2} position={[0, 4, 0]} scale={[10, 1, 1]} />
          ...
          {/* Sides */}
          <Lightformer intensity={30} rotation-y={Math.PI / 2} position={[-50, 2, 0]} scale={[100, 2, 1]} />
          <Lightformer intensity={30} rotation-y={-Math.PI / 2} position={[50, 2, 0]} scale={[100, 2, 1]} />
          {/* Key */}
